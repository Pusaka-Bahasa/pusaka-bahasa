    ...
    <nav className="fixed w-full z-20 top-0 start-0 navTops">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-6 py-6">
        ...
        <div className="md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse lg:block sm:hidden hidden">
          <span className="flex flex-col-1 lg:gap-2 font-medium sm:gap-1 md:gap-1 gap- items-center lg:px-4 lg:py-2 sm:px-2.5 sm:py-2.5 px-2 py-1 md:px-2.5 md:py-2.5" style={{ background: "#e8f549", borderRadius: "10px" }}>
            ...
            <a href="#" className="block py-2 px-3 rounded md:p-0" aria-current="page" style={{ color: "#0c4b54" }}>
              Indonesia
            </a>
          </span>
        </div>
